...
<div className="text-center">
 ...
 <h2 className="text-3xl font-bold md:mb-10 text-center text-[#333333]">Sign up</h2>
...
<input
 ...
 className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-gray-100 p-2"
            ...
            <button
              type="submit"
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#F39C12] hover:bg-[#E67E22] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#E67E22]"
            >
              Sign up
            </button>
          </form>
          ...
          <div className="text-center">
            <button
              ...
              className="mt-2 py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Sign in Here
            </button>
          </div>
